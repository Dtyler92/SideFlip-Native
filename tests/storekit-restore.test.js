...
test('restore processes the authoritative active purchase list without a fixed delay', () => {
  ...
  assert.match(restoreSource, /queryRestorablePurchases\(/)
  assert.match(restoreSource, /syncPurchases: restorePurchases/)
  assert.match(restoreSource, /getAvailablePurchases,/)
  assert.match(restoreSource, /apple_restore_sync_failed/)
