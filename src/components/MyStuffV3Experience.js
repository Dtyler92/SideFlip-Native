...
export default function MyStuffV3Experience({ item, definitions = [], plannedOccurrences = [], formatMoney, currency, activeTab = 'Maintenance', onTabChange, onRefresh, onStartSelling, transferring = false, operationLock, parentBusy = false, maintenanceUsageSection = null }) {
